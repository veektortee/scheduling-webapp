        ...
        if response.status_code == 200:
            ...
            if 'solver_info' in result:
                ...
                if isinstance(variables, int) and variables > 8000:
                    print("✅ Using REAL scheduler_sat_core.py (high variable count)")
                    print("✅ Advanced medical scheduling solver is active!")
                else:
                    print(f"⚠️  Variable count ({variables}) suggests fallback solver")
